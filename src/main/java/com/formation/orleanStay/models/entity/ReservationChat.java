...
public class ReservationChat {
    ...
    @ManyToOne
    @JoinColumn(name = "utilisateur_id", nullable = false, foreignKey = @ForeignKey(name = "fk_utilisateur_reservationChat"))
    private Utilisateur utilisateur;
    ...
    @ManyToOne
    @JoinColumn(name = "reservation_id", nullable = false, foreignKey = @ForeignKey(name = "fk_reservation_reservationChat"))
    private Reservation reservation;
